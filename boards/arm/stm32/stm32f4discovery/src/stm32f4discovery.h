...
/* Keypad Matrix - 4x3 Configuration
 * Rows: PB0-PB3 (outputs)
 * Columns: PC0-PC2 (inputs with pull-up)
 */

#define BOARD_KMATRIX_ROW0      (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|\
                                GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN0)
#define BOARD_KMATRIX_ROW1      (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|\
                                GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN1)
#define BOARD_KMATRIX_ROW2      (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|\
                                GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN2)
#define BOARD_KMATRIX_ROW3      (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|\
                                GPIO_OUTPUT_SET|GPIO_PORTB|GPIO_PIN3)

#define BOARD_KMATRIX_COL0      (GPIO_INPUT|GPIO_PULLUP|GPIO_PORTC|GPIO_PIN0)
#define BOARD_KMATRIX_COL1      (GPIO_INPUT|GPIO_PULLUP|GPIO_PORTC|GPIO_PIN1)
#define BOARD_KMATRIX_COL2      (GPIO_INPUT|GPIO_PULLUP|GPIO_PORTC|GPIO_PIN2)
