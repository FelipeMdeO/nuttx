...
#define GPIO_KMATRIX_COL0  (GPIO_INPUT|GPIO_PULLDOWN|GPIO_SPEED_50MHz|\
                            GPIO_PORTB|GPIO_PIN0)
#define GPIO_KMATRIX_COL1  (GPIO_INPUT|GPIO_PULLDOWN|GPIO_SPEED_50MHz|\
                            GPIO_PORTB|GPIO_PIN1)
#define GPIO_KMATRIX_COL2  (GPIO_INPUT|GPIO_PULLDOWN|GPIO_SPEED_50MHz|\
